...
public partial class AdminPanel_CandidateBasicDetails_CandidateBasicDetailsList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Page.Title = "Candidate Basic Details - Admin";
    ...
    private void Search()
    {
        ...
        DataTable dt = balCandidateBasicDetails.SelectAll();
        if (dt.Rows.Count > 0)
        {
    ...
    protected void rpData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "DeleteRecord")
        {
            try
            {
                ...
                {
                    if (balCandidateBasicDetails.Delete(Convert.ToInt32(e.CommandArgument)))
                    {
                        lblMessage.Text = "Delete Deleted Successfully";
