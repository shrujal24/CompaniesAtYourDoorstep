...
public partial class AdminPanel_Question_QuestionList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Page.Title = "Question - Admin";
    ...
    private void Search()
    {
        ...
        DataTable dt = balQuestion.SelectAll();
        if (dt.Rows.Count > 0)
        {
    ...
    protected void rpData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "DeleteRecord")
        {
            try
            {
                ...
                {
                    if (balQuestion.Delete(Convert.ToInt32(e.CommandArgument)))
                    {
